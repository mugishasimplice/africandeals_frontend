        ...
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                    ${partner.logo_url ? `
                        <img src="${processImageUrl(partner.logo_url)}" alt="${partner.name}" class="w-12 h-12 object-contain rounded-lg mr-3">
                    ` : `
    ...
    tbody.innerHTML = promotions.map(promotion => `
        <tr>
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                    ${promotion.image_url ? `
                        <img src="${processImageUrl(promotion.image_url)}" alt="${promotion.title}" class="w-16 h-12 object-cover rounded-lg mr-3">
                    ` : `
